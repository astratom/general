...
Try {
	...
	[string]$appScriptDate = '23/06/2021'
	[string]$appScriptAuthor = 'tastrsks'
	##*===============================================
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		# Remove mark of the web on all the files, otherwise running the exe to register file associations in user context will fail
